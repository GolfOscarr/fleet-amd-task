...
Last updated: 2026-09-16 (round 2: M4, the fault's cause, the timings; `docs/round-2/`) · 5 major open (MAJ-7 measured: the megakernel's per-task overhead) · **15 minor open** · 31 resolved · 9 documentation defects
