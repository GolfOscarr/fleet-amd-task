...
fail=0
for f in mla_prep_mi300 mla_attend_mi300 mla_attend_mfma_mi300 mla_merge_uv_mi300 moe_router_mi300 copy_mi300 prefetch_mi300 linear_gemv_mi300 gang_moe_w2_silu_mi300; do
  src="$KDIR/$f.cuh"
