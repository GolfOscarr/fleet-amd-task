...
error. `docs/gpu-experiments/01-bringup/01-plan.md` says why each group is collected and
`docs/gpu-experiments/01-bringup/02-checklist.md` gives the row each command line fills.
