...
| time per iteration from host wall clock (us) |  | 5156.8 |
...
| tokens per second |  | - |
| GFX clock from amd-smi during the run, median / max (MHz) | 2100 max (D2 of round 1) | 2104 / 2104 over 59 samples |
