...
The run made 32 iterations: the boundaries other than the cache rows and the first token were dumped from iteration 31 and are not comparable against the reference's step 0 (NOT_COMPARABLE below); the output ids and the route log carry the verdict.
...
| `L26.B11.expert_10` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
...
| `L26.B11.expert_29` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L26.B11.expert_58` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L26.B11.expert_62` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
...
| `head.B15.logits` | B15 | logits | - | - | - | - | exact | **NOT_COMPARABLE** dumped from iteration 31; the reference has no ref_boundaries_step31 |
| `head.B16.token` | B16 | exact | - | - | - | - | exact | **PASS** fleet 25 ref 25 |

Output ids: **PASS**, 32 of 32 matched.
Route log: **PASS**, 32 steps compared, 41 mismatching (step, layer) pairs: 19 ties, 22 cascades, 0 disagreements (the tie rule, tol 0.0144 of the larger weight).
