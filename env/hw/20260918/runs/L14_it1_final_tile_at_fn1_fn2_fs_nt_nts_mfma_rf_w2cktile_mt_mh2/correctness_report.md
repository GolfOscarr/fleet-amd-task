...
| `L13.B2.q` | B2 | gemv | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
...
| `L13.B4.q_pe` | B4 | rope | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L13.B6.attn` | B6 | attention | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L13.B8.router_logits` | B8 | router | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L13.B9.topk_idx` | B9 | exact | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L13.B10.topk_w` | B10 | router | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L13.B11.expert_16` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L13.B11.expert_2` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L13.B11.expert_54` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L13.B11.expert_55` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L13.B11.expert_60` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L13.B11.expert_61` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L13.B12.shared` | B12 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L13.B13.layer_out` | B13 | layer | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
...
Overall: **PASS** (5 pass, 0 fail, 0 missing, 38 of layers the reference did not capture).
