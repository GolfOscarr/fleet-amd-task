...
| `L26.B11.expert_25` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L26.B11.expert_40` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
| `L26.B11.expert_43` | B11 | expert | - | - | - | - | exact | **NOT_CAPTURED** the reference captures layers 0, 1 |
...
Overall: **PASS** (8 pass, 0 fail, 0 missing, 64 of layers the reference did not capture).
