# Hardware collection 20260918

Collected on 20260918 on enc1-gpuvm016, ROCm 7.2.4, hipcc 7.2.53211. 62 checklist rows: 32 PASS, 5 MISMATCH, 23 INFO, 2 UNAVAILABLE. Raw captures are in raw/, one file per command, and collect.log holds the run. Every MISMATCH belongs in OPEN-PROBLEMS.md and the owning 99-open-questions.md with its date and command (docs/gpu-experiments/01-bringup/02-checklist.md, Sign-off).
...
| B11 | Wall-clock rate | rate 100000 kHz, ratio 0.976615 | the attribute and the host clock agree within 1% | MISMATCH |
...
| D2 | Engine clock | current 160 MHz, max 2,100 MHz, rocminfo 0 MHz, kfd 2100 kHz | INFO; about 2,100 MHz max (gk) | INFO |
| D3 | Power cap and draw | draw 160 W | INFO; cap at the 750 W class (gk) | INFO |
| D4 | Temperature and throttle | 44 °C, throttle status not readable: --throttle is not a flag in this amd-smi | no throttle flags | INFO |
| D5 | Memory in use, processes | 0.28 GiB used, 0 process(es) | near 0, no other process | PASS |
| E1 | Read bandwidth, full, 1 GiB, N=8 | 3 runs, mean 3.872 TB/s, spread 4.24% | 3.66 to 4.3 TB/s; spread under 3% | MISMATCH |
| E2 | Bandwidth at one wave/SIMD vs N | knee at N=4, plateau 4026 GB/s (N1:2595, N2:3167, N4:3741, N8:3690, N16:4026, N32:3559) | knee at N about 4, plateau within 10% of E1 | PASS |
| E3 | Same at two waves/SIMD | knee at N=2, plateau 3905 GB/s (E2 knee 4, so at or below N=2) | plateau at about half the N of E2 | PASS |
| E4 | Bandwidth vs working set | 4MiB:6991, 16MiB:7630, 32MiB:7173, 64MiB:3690, 128MiB:3769, 256MiB:4353, 512MiB:4127, 1024MiB:2558; step above 32 MiB: yes; above 256 MiB: no | step above 32 MiB (L2) and above 256 MiB (Infinity Cache) | INFO |
| E5 | BabelStream | Copy 4,335,032 MB/s, Mul 4,059,082 MB/s, Add 4,082,443 MB/s, Triad 3,926,119 MB/s, Dot 3,988,306 MB/s | Dot >= 3,660,781 MB/s, Copy >= 4,177,285 MB/s | PASS |
...
| H1 | L2 hit latency | 87.0 ns wall, 86.8 ns s_memrealtime | INFO | INFO |
| H2 | Infinity Cache latency | 262.6 ns wall, 262.0 ns s_memrealtime | INFO; about 218 ns from a secondary source | INFO |
| H3 | HBM latency | 359.1 ns wall, 358.3 ns s_memrealtime | INFO; 250 ns to 2 us; flag only above 2 us | INFO |
| H4 | Release fence cost | 130.1 ns (agent 646.4 ns, workgroup 516.3 ns) | INFO; under 1 us | INFO |
| H5 | Acquire fence cost | 121.7 ns (agent 630.2 ns, workgroup 508.5 ns) | INFO; under 1 us | INFO |
| H6 | Fence cost, eight XCDs | release 105.9 ns (agent 866.1 ns, workgroup 760.2 ns); acquire 78.6 ns (agent 826.0 ns, workgroup 747.5 ns) | INFO | INFO |
| H7 | Cross-XCD one-way latency | 696.1 ns one way (XCD 0 to 1, 10000 rounds) | INFO; 116 to 202.5 ns from a secondary source | INFO |
...
| I4 | Kernel trace | 1 copy_kernel dispatch(es), first 760,097 ns | one dispatch row with a duration | PASS |
