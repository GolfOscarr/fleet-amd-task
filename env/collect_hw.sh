...
# (docs/gpu-experiments/01-bringup/01-plan.md, docs/gpu-experiments/01-bringup/02-checklist.md).
#
...
echo "log:        $LOG"
echo "next: read the summary against docs/gpu-experiments/01-bringup/02-checklist.md, file every"
