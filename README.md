...
must move (`09-session-log.md`, `10-results.md`).
...
| Open problems | 5 major open (MAJ-8: the runtime's per-task completion cost, not what bounds the GEMV linears by round 4's grid sweep; MAJ-7 resolved in round 3 as a measurement defect), 18 minor, 34 resolved ([`OPEN-PROBLEMS.md`](OPEN-PROBLEMS.md)) |
