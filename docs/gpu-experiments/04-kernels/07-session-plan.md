...
| `ktime nt` | the attention grid about 34 us cold, the merge 11.5; the GEMV grids (qkva's 96 tasks of 38 rows, o_proj's 64 of 32, cold) are the question; the router, w13, w2 and o_proj-fold rows new |
