...
- The session scripts (`env/session/`: `laptop.sh`, `vm.sh`, `queue.sh`,
  ...
  then `L start setup` (73 s; 8 minutes on a fresh host with the
  download and the hardware census).
