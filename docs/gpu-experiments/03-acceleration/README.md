...
| [`08-results.md`](08-results.md) | the numbers: 9,575 to 4,578 to 4,600 us per token on the event clock (4,584 by `FWD_PASS`), ids equal; where the time goes per operator before and after; the kernels standalone; every lever's verdict; the measurement corrections; what remains for 4.5 ms and below |
