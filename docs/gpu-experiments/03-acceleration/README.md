...
| 2026-09-17 | laptop parts of O0, O1, O2, O5, O6 and O3 done on `local/round-3` (each a commit; the flags `--fuse-norm2`, `--fuse-silu`, `--fuse-norm1`, `--probe-before`, `--nt-streams`, all default off until the VM validates them): with the three fusions the graph is 246 operators instead of 326; O7, O8 and the instruments remain; no VM |
