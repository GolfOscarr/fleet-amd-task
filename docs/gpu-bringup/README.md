...
| [`05-next-session.md`](05-next-session.md) | superseded by [`docs/round-2/02-session-plan.md`](../round-2/02-session-plan.md); from a fresh VM to a running graph in ten minutes with the pushed image; what to do first |
